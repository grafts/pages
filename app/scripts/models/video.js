	...
	var VideoModel = Backbone.Model.extend({
		defaults: {
			...
			contents : [
				...
				{time : 2000, script : { title : '챔피언 픽', texts : dummyText}, comments : [{id : 1, author : {id : 1, name : '아만다 사이프리드', avatar : '/images/avatar.jpg'}, comment : 'Words of wisdom indeed. But i do enjoy my midnight break and stroll to the 7-11!', date : 'a days ago'} ] }, 
